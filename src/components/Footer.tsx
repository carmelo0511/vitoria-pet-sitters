...
const Footer = () => {
  ...
  return <footer id="contact" className="py-8 px-4 md:px-8 bg-background">
      <div className="rounded-2xl text-card py-16 px-6 md:px-12 bg-primary">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map(link => <li key={link.label}>
                  <a href={link.href} className="text-card/70 hover:text-primary transition-colors">
                    {link.label}
                  </a>
                </li>)}
            </ul>
        ...
        <div className="border-t border-card/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2">
            <a href="https://www.instagram.com/larissabpetsitting" target="_blank" rel="noopener noreferrer" className="text-card/50 hover:text-primary transition-colors text-sm flex items-center gap-2">
