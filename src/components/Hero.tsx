  ...
  return (
    <section id="hero" className="pt-24 pb-8 px-4 md:px-8 bg-background">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white/85 to-white/70" />
        ...
        <div className="relative z-10 px-8 md:px-16 lg:px-24 py-16">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 flex items-center gap-2">
              ...
              <span className="font-medium text-foreground">Atendimento: Vitória, Vila Velha e Cariacica</span>
            </p>
